...
game={
	...
	start=function(self)
		...
		add(self.entities,straight_shooter:C(self, 64, 64, 1.5, 0, 15))
	end
}
...
basic_bullet={
	C=function(self,game,x,y,dx,dy,s)
		o={x=x,y=y,dx=dx,dy=dy,s=s,l=1,t=0,game=game}
		setmetatable(o,{__index=self})
		return o
	end,
	update=function(self)
...

...

